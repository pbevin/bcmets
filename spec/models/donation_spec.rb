...
describe Donation do
  ...
  it "should require all fields" do
    Donation.make_unsaved(:date => nil).should_not be_valid
    Donation.make_unsaved(:amount => nil).should_not be_valid
    Donation.make_unsaved(:email => nil).should_not be_valid
  end
end
